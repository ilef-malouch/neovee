...
export class Addcol1700329380595 implements MigrationInterface {
    name = 'Addcol1700329380595'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`article\` CHANGE \`authorId\` \`authorId\` int NOT NULL`);
